...
const staffOnboardingResponse = async (req, res) => {
    ...
    try {
        ...
        // check if this form was assigned to school

        let check_school = await School.find({ _id: school_id },
            {  staffs_onboarding_form_assigned: { $elemMatch: { form_id: form_id } } })
...
export default staffOnboardingResponse;
